        ...
        <div class="row status-section">
            <div class="col-12">
                ...
                <asp:Panel ID="Amount_Panel" Class="box_panel" runat="server">
                    <div style="text-align:right;" ><asp:Label ID="Label6" CssClass="lbl" runat="server" Text="Graph"></asp:Label> <button type="button" class="btn grp_show"><i class="fa fa-bar-chart"></i></button></div>
             ...
             <div class='popup'>
                 <h5 align="center">Ledger Outstanding Graph <label class="br_name"></label></h5>
