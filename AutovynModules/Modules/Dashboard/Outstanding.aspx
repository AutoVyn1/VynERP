<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AutovynModules/AUTOVYN.Master" CodeBehind="Outstanding.aspx.vb"  Inherits="AutovynERP.Outstanding" %>
                   ...
                   <asp:Label ID="Label3" CssClass="col-sm-1 col-form-label" runat="server" Text="Group"></asp:Label>
                    <div class="col-sm-2">
                        <asp:DropDownList ID="grp_name" CssClass="form-control" runat="server">
                           ...
                           <asp:ListItem Value="52">Service Outstanding</asp:ListItem>
                           <asp:ListItem Value="53">New Car Outstanding</asp:ListItem>
                           <asp:ListItem Value="57">Bodyshop Outstanding</asp:ListItem>
                           <asp:ListItem Value="58">TV Outstanding</asp:ListItem>
                            <asp:ListItem Value="56">Insurance Renewed Outstanding </asp:ListItem>
        ...
        <script>
         ...
         <script>
             ...
             $("#Load_Location").click(function () {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "Outstanding.aspx/GetChartData",
             ...
             function myFunction(xValue) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "Outstanding.aspx/GetChartData2",
             ...
             function myFunction_day(xValue) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "Outstanding.aspx/GetChartData_day",
                     data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (response) {
             ...
             function myFunction_branch(xValue) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "Outstanding.aspx/GetChartData_branch",
                     data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     beforeSend: function () {
