<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AutovynModules/AUTOVYN.Master" CodeBehind="profit.aspx.vb"  Inherits="AutovynERP.profit" %>
        ...
        <script>
         ...
         <script>
			 ...
			 function myFunction_day(xValue) {
				 ...
				 $.ajax({
					 type: "POST",
					 url: "profit.aspx/GetChartData_day",
					 data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
					 contentType: "application/json; charset=utf-8",
					 dataType: "json",
					 success: function (response) {
			 ...
			 function myFunction_branch(xValue) {
				 ...
				 $.ajax({
					 type: "POST",
					 url: "profit.aspx/GetChartData_branch",
					 data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
					 contentType: "application/json; charset=utf-8",
					 dataType: "json",
					 beforeSend: function () {
