<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AutovynModules/AUTOVYN.Master" CodeBehind="Ledg_dashboard.aspx.vb"  Inherits="AutovynERP.Ledg_dashboard" %>
        ...
        <script>
         ...
         <script>
			 ...
			 $("#Load_Location").click(function () {
				 ...
				 $.ajax({
					 type: "POST",
					 url: "Ledg_dashboard.aspx/GetChartData",
			 ...
			 function myFunction_day(xValue) {
				 ...
				 $.ajax({
					 type: "POST",
					 url: "Ledg_dashboard.aspx/GetChartData_day",
					 data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
					 contentType: "application/json; charset=utf-8",
					 dataType: "json",
					 success: function (response) {
			 ...
			 function myFunction_branch(xValue) {
				 ...
				 $.ajax({
					 type: "POST",
					 url: "Ledg_dashboard.aspx/GetChartData_branch",
					 data: "{grp_name: '" + grp_name + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "', xValue:'" + xValue + "'}",
					 contentType: "application/json; charset=utf-8",
					 dataType: "json",
					 beforeSend: function () {
